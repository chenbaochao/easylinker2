...
public class QRCodeGenerator {
    ...
    public static String generateQRCode(String deviceId) {
        String path = "/device/qrCode/" + deviceId + ".png";
        ...
        try {
            ...
            //http://localhost/qrCode/device/2423de45t46g465   通过二维码的HTTP请求 就可以获取数据
            BitMatrix matrix = writer.encode("/qrCode/device/" + deviceId, BarcodeFormat.QR_CODE, HEIGHT, WIDTH);
